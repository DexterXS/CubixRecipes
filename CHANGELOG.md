...
### Fixed
- Fixed the admin icon settings grid and Auctions NEI picker sizing: center-mode buttons now wrap instead of overlapping, and the opened-lot NEI catalog uses exact square cells from the `auctionNei` icon-surface settings instead of stretching columns.
