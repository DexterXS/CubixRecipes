...
## [Unreleased]
### Added
- Added zoned frontend docking layout with separate top-left, top-right, bottom, and sidebar drop targets, per-zone drag reorder, visible drop-zone highlighting, and working width resize inside zones while preserving persisted panel preferences and visibility controls.
