...
## [Unreleased]
### Added
- Added zoned frontend docking layout with separate top-left, top-right, bottom, and sidebar drop targets, per-zone drag reorder, and visible drop-zone highlighting while preserving persisted panel preferences and resize/visibility controls.
