...
def test_parse_extreme_recipe_matrix_with_nbt_item_references():
    parser = RecipeParser()
    text = r'''mods.avaritia.ExtremeCrafting.addShaped(<energyadditions:eareplicatorupgrade2>,\n\t[[null, null, null, null, <IC2:itemDensePlates:8>, null, null, null, null],\n\t[null, null, <IC2:itemDensePlates:8>, <IC2:itemDensePlates:8>, <minecraft:enchanted_book>.withTag({StoredEnchantments: [{lvl: 3 as short, id: 35 as short}]}), <IC2:itemDensePlates:8>, <IC2:itemDensePlates:8>, null, null],\n\t[null, <IC2:itemDensePlates:8>, <minecraft:enchanted_book>.withTag({StoredEnchantments: [{lvl: 3 as short, id: 35 as short}]}), <energyadditions:easolartype1>, <Avaritia:Resource:5>, <energyadditions:easolartype1>, <minecraft:enchanted_book>.withTag({StoredEnchantments: [{lvl: 3 as short, id: 35 as short}]}), <IC2:itemDensePlates:8>, null],\n\t[null, <IC2:itemDensePlates:8>, <energyadditions:easolartype1>, <Avaritia:Singularity:2>, <energyadditions:eaomegacore>, <Avaritia:Singularity:2>, <energyadditions:easolartype1>, <IC2:itemDensePlates:8>, null],\n\t[<IC2:itemDensePlates:8>, <minecraft:enchanted_book>.withTag({StoredEnchantments: [{lvl: 3 as short, id: 35 as short}]}), <Avaritia:Resource:5>, <energyadditions:eaomegacore>, <minecraft:enchanted_book>.withTag({StoredEnchantments: [{lvl: 3 as short, id: 35 as short}]}), <energyadditions:eaomegacore>, <Avaritia:Resource:5>, <minecraft:enchanted_book>.withTag({StoredEnchantments: [{lvl: 3 as short, id: 35 as short}]}), <IC2:itemDensePlates:8>],\n\t[null, <IC2:itemDensePlates:8>, <energyadditions:easolartype1>, <Avaritia:Singularity:2>, <energyadditions:eaomegacore>, <Avaritia:Singularity:2>, <energyadditions:easolartype1>, <IC2:itemDensePlates:8>, null],\n\t[null, <IC2:itemDensePlates:8>, <minecraft:enchanted_book>.withTag({StoredEnchantments: [{lvl: 3 as short, id: 35 as short}]}), <energyadditions:easolartype1>, <Avaritia:Resource:5>, <energyadditions:easolartype1>, <minecraft:enchanted_book>.withTag({StoredEnchantments: [{lvl: 3 as short, id: 35 as short}]}), <IC2:itemDensePlates:8>, null],\n\t[null, null, <IC2:itemDensePlates:8>, <IC2:itemDensePlates:8>, <minecraft:enchanted_book>.withTag({StoredEnchantments: [{lvl: 3 as short, id: 35 as short}]}), <IC2:itemDensePlates:8>, <IC2:itemDensePlates:8>, null, null],\n\t[null, null, null, null, <IC2:itemDensePlates:8>, null, null, null, null]]);'''
    recipe = parser.parse(text).recipe
    assert recipe.recipe_type == 'avaritia_extreme_shaped'
