...
- Явный сценарий парсинга во frontend: большое действие «Распарсить в сетку», статусы backend/parsing/result рядом с полем и авто-парсинг при вставке текста в редактор.
